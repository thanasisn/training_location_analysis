...
con_Gactivities <- dbConnect(RSQLite::SQLite(),
                             "~/TRAIN/Volumes/HealthData/DBs/garmin_activities.db")
con_Gmonitoring <- dbConnect(RSQLite::SQLite(),
                             "~/TRAIN/Volumes/HealthData/DBs/garmin_monitoring.db")
con_Gsummary    <- dbConnect(RSQLite::SQLite(),
                             "~/TRAIN/Volumes/HealthData/DBs/garmin_summary.db")
con_Garmin      <- dbConnect(RSQLite::SQLite(),
                             "~/TRAIN/Volumes/HealthData/DBs/garmin.db")
con_summary     <- dbConnect(RSQLite::SQLite(),
                             "~/TRAIN/Volumes/HealthData/DBs/summary.db")
